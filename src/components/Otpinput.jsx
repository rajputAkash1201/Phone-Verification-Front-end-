        ...
        return (
            <form onSubmit={this.handleSubmit} style={{
                ...
                <div className="otpContainer">
                    <h2 style={{ textAlign: "center", color: "grey", fontSize: "0.8rem", marginTop: "10px" }}>
                ...
                <div className="change-reSend">
                    <button className="changeNumber">Change Number</button>
                    <button className="re-send">Re-send OTP</button>
                </div>
